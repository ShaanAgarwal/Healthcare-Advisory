...
departments=[('Breast Cancer Specialist','Breast Cancer Specialist'),
...
class Doctor(models.Model):
    ...
    department= models.CharField(max_length=50,choices=departments,default='Breast Cancer Specialist')
